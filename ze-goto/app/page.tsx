...
import AlertDetailsPanel from '@/components/AlertsPanel/AlertDetailsPanel';
...
const Home = () => {
  ...
  const recentAlerts: Alert[] = [
    { id: 1, type: 'obstruction', severity: 'high', location: 'Galeria Anhangabaú - Setor 7', time: '10:23', robot: 'ZG-003', description: 'Obstrução grande detectada - possível acúmulo de detritos' },
    { id: 2, type: 'structural', severity: 'medium', location: 'Galeria Vila Madalena - Setor 12', time: '09:45', robot: 'ZG-007', description: 'Rachadura na parede lateral identificada' },
    { id: 3, type: 'water_level', severity: 'low', location: 'Galeria Ibirapuera - Setor 3', time: '08:15', robot: 'ZG-001', description: 'Nível de água ligeiramente elevado' }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 text-white">
      ...
      <div className="container mx-auto px-6 py-8">
        ...
        {/* Painel de detalhes */}
        {selectedAlert && (
          <div className="fixed bottom-4 right-4 w-full max-w-sm bg-slate-800 border border-slate-700 p-4 rounded-lg shadow-xl">
            <h3 className="text-lg font-bold text-white mb-2">Detalhes do Alerta</h3>
            <p className="text-sm text-gray-300 mb-1">{selectedAlert.description}</p>
            <p className="text-sm text-gray-400">Local: {selectedAlert.location}</p>
            <p className="text-sm text-gray-400">Robô: {selectedAlert.robot}</p>
            <p className="text-sm text-gray-400">Horário: {selectedAlert.time}</p>
            <button
